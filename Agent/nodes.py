...
def select_problem_node(state: DSAState) -> DSAState:
    ...
    # A new problem always needs its own assignment record — reusing
    # a stale problem_assignment_id from a previous problem in this
    # session would point future submission checks/status updates at
    # the wrong problem_id and assigned_at timestamp.
